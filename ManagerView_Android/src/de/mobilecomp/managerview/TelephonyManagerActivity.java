...
//		List<NeighboringCellInfo> neighboringCellInfos = new ArrayList<NeighboringCellInfo>();
//		neighboringCellInfos.add(null);
//		neighboringCellInfos.add(null);
//		neighboringCellInfos.add(null);
//		neighboringCellInfos.add(null);
		...
		LayoutInflater inflater = (LayoutInflater) getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			...
			for (int i = 0; i < neighboringCellInfos.size(); i++)
			{
				...
				((ViewGroup) insertPoint).addView(view, i + 2, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
			}
		}
		...
		((TextView) findViewById(R.id.networkOperatorName)).setText(networkOperatorName);

		String simOperatorName = telephonyManager.getSimOperatorName();
		((TextView) findViewById(R.id.simOperatorName)).setText(simOperatorName);
	...
	private class HttpRequestTask extends AsyncTask<String, Void, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			try
			{
				...
				((TextView) findViewById(R.id.longitude)).setText(String.valueOf(cell.getAttribute("lon").getValue()));
				((TextView) findViewById(R.id.latitude)).setText(String.valueOf(cell.getAttribute("lat").getValue()));
			}
			catch
			(JDOMException e)
			{
